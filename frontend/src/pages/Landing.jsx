      ...
      <footer className="py-12 px-4 sm:px-6 lg:px-8 bg-gray-900 text-white">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              <a href="https://suite.doid.it" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
              ...
              <a href="https://suite.doid.it" className="text-sm text-gray-400 hover:text-white transition-colors">suite.doid.it</a>
            </div>
